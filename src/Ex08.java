...
public class Ex08 { /*
    	...
    	try (Scanner scan = new Scanner(System.in);
               ...
               while(true) {
                   try {
                       ...
                       write.println("non-integer-input");
        ...
        try (Scanner fileScanner = new Scanner(new File(filename))) {
            while (fileScanner.hasNext()) {
                try {
                    ...
                    System.out.println("Error reading integer from file: " + e.getMessage());
    ...
    public static void replaceNumbers(String filename, int oldNum, int newNum) {
         ...
         */
         ...
         // Your code goes here...
    	try (Scanner fileScanner = new Scanner(new File(filename));
                PrintWriter writer = new PrintWriter(new File(filename + ".tmp"))) {
           ...
           if (tempFile.renameTo(File1)) {
               System.out.println("Numbers replaced.");
           } else {
...
Pidgey Flying Normal 40 45 40 35 35 56
    ...
    public static String[] readFilterPokeType(String filename, String poketype) {
         ...
         */
         ...
         // Your code goes here...
    	ArrayList<String> matchingPokemon = new ArrayList<>();
        ...
        try (Scanner fileScanner = new Scanner(new File(filename))) {
            ...
            while (fileScanner.hasNextLine()) {
                ...
                if (type.equals(poketype) || (type2 != null && type2.equals(poketype))) {
                    matchingPokemon.add(name);
                }
            }
        } catch (FileNotFoundException e) {
            System.out.println("File not found: " + filename);
        ...
        return matchingPokemon.toArray(new String[0]);
    }
